...
The progress report uses attempts saved by the on-screen quiz app in the same browser profile. If no attempts appear, take or restart one on-screen exam first.
</div>
